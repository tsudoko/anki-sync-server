...
# Monkey patch anki.importing.anki2 to support updating existing notes on Anki
# versions 2.0.12 and earlier. This was added upstream with version 2.0.13.
if StrictVersion(anki_version) < StrictVersion('2.0.13'):
    ...
    Anki2Importer.allowUpdate = True
